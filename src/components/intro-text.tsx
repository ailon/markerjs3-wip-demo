    ...
    <PropertyPanel title="marker.js 3 Demo">
      <div className="col-span-2 space-y-4">
        ...
        <p>
          ...
          simplistic toolbar and here, instead of this text, you'll see
          marker properties when a marker is selected (both part of this demo
          but not marker.js 3)
        </p>

        <p>
          When you click "save", MarkerView block shows a dynamic view of the
          annotations using marker.js 3 viewer component and the Rendered Image block - a
        ...
        <p>
          ...
          <a href="https://github.com/ailon/markerjs3-wip-demo">explore the code</a> and
