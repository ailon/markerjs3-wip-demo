    ...
    <div className="flex flex-col items-center bg-slate-300">
      <div className="flex flex-row justify-between items-center p-4 w-full">
        ...
        <div className="flex flex-row items-center space-x-3">
          <a href="https://stackblitz.com/~/github.com/ailon/markerjs3-wip-demo" aria-label="Live demo on StackBlitz" className="flex w-6 h-6">
          ...
          <a href="https://github.com/ailon/markerjs3-wip-demo" aria-label="GitHub Repository" className="flex w-6 h-6">
